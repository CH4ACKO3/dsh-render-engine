...
export class HtmlAnsiRenderer implements AnsiRendererService {
  render(request: AnsiRenderRequest): AnsiRenderResult {
    ...
    return {
      html: `<pre class="dsh-ansi-render" style="margin:0;overflow:auto;color:var(--dsh-ansi-foreground,var(--shiki-foreground));background-color:var(--dsh-ansi-background,var(--shiki-background));font:var(--dsw-font-markdown-code-block,13px/1.65 monospace)" tabindex="0"><code>${content}</code></pre>`,
